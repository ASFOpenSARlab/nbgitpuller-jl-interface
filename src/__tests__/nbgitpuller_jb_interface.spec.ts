...
describe('nbgitpuller-jl-interface utils checkForRepoUpdates', () => {
  ...
  it("one update", async() => {
    ...
    .mockImplementationOnce(async () => Promise.resolve({
        ok: true,
        json: () => Promise.resolve({ "returncode": 0, "updatefound": true, "repoexists": true}),
        status: 200,
    ...
    expect(returnValue).toStrictEqual({"response":{"numToBeUpdated":1,"numWithErrors":0},"statuscode":0})
  });
  ...
  it("one error", async() => {
    ...
    .mockImplementationOnce(async () => Promise.resolve({
        ok: true,
        json: () => Promise.resolve({ "returncode": 1, "updatefound": true, "repoexists": true}),
        status: 200,
      }) as unknown as Response
    );
    ...
    expect(returnValue).toStrictEqual({"response":{"numToBeUpdated":0,"numWithErrors":1},"statuscode":0})
  });
  ...
  it("mixed return", async() => {
    ...
    .mockImplementationOnce(async () => Promise.resolve({
        ok: true,
        json: () => Promise.resolve({ "returncode": 1, "updatefound": false, "repoexists": true}),
        status: 200,
      }) as unknown as Response
    )
    .mockImplementationOnce(async () => Promise.resolve({
    ...
    expect(returnValue).toStrictEqual({"response":{"numToBeUpdated":2,"numWithErrors":1},"statuscode":0})
  });
});
...
describe('nbgitpuller-jl-interface utils setUpdateButtonDisplay', () => {
  ...
  it("widget not found", async() => {
    ...
    expect(returnValue).toStrictEqual({ error: 'Unable to find nbgitpuller widget', returncode: 1 })
  });
});
